...
class Calculate(Base):
    ...
    therapistName= Column(String(255))
    treatmentHosName= Column(String(255))
    registerNo_Str= Column(String(255))
    year_Str= Column(String(255))
    ...
    def to_dict(self):
        return{
            ...
            'therapistName':str(self.therapistName),
            'treatmentHosName':str(self.treatmentHosName),
            'registerNo_Str':str(self.registerNo_Str),
            'year_Str':str(self.year_Str),
            'month_Str':str(self.month_Str),
...
def sort_insureName_4Sokatsu1():
    Session = sessionmaker(bind=engine)
    ses = Session()
    re = ses.query(Calculate).all()
    calcu_list = get_by_list(re)
    insDestSort2=[]
